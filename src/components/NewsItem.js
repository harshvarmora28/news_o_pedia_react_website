        ...
        <div>
            <div className="card my-2" id="news-card">
                ...
                <div className="card-body">
                    <h5 className="card-title">{props.title}...<span className="position-absolute text-dark top-0 translate-middle badge rounded-pill" id="news-bubble" style={{fontSize: "10px", left: "91%", boxShadow: "0px 1px 2px black", zIndex: "1"}}>{props.source}
